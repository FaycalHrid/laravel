    ...
    class Email extends \ElasticEmailClient\ElasticRequest
{
     ...
     */
    public function GetStatus($transactionID, $showFailed = true, $showSent = true, $showDelivered = true, $showPending = true, $showOpened = true, $showClicked = true, $showAbuse = true, $showUnsubscribed = true, $showErrors = true, $showMessageIDs = true) {
